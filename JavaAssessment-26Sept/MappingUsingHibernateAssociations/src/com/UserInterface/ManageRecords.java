...
public class ManageRecords {
	...
	public static void main(String args[]) {
		...
		Integer customer1=customerServices.addCustomer("lily", "disuza", "9602653878");
		Integer customer2=customerServices.addCustomer("john", "oberoi", "9461404491");
		...
		try {
			customerServices.deleteCustomerById(3);
		}
		catch(Exception e) {
			e.printStackTrace();
		}
